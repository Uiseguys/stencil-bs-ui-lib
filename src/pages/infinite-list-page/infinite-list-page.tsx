...
export class CwcInfiniteList {
  ...
  @State() users2: any[] = [];
     ...
     @State() users3: any = [{"gender":"female","name":{"title":"miss","first":"louane","last":"vidal"},
  ...
  loadMoreUsers(count: number, data ): void {
    const page = this.getPage(data)
    this.getUsers(count, page).then(users => {
  ...
  // Users data methods
  componentWillLoad() {
    this.loadMoreUsers(10, this.users1)
    this.loadMoreUsers(10, this.users2);
  }
    ...
    return [
      <div class="container">
        <div>
          ...
          <h2>
            Usage with <code>cwc-list</code> component inside container
          </h2>
...
<cwc-infinite-list-watcher 
    ...
    listSelector=".item-list-wrapper"
    ...
    <cwc-list 
        ...
        <div class="w-100">
          ...
          <cwc-infinite-list-watcher
            onOnBottomReach={() => console.log('reach')}
            listSelector=".item-list-wrapper"
            lastItemSelector="div.boxed-item-last"
            debounce={1000}
            bindToList={true}
          ...
          <h4>
            ...
            <a href="randomuser.me">randomuser.me</a>:{" "}
          </h4>
          <br />
          <div>
            <br />
...
`}
      ...
      <cwc-infinite-list-watcher
        onOnBottomReach={() => console.log("Bottomreach handler!")}

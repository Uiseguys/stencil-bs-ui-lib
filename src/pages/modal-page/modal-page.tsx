                ...
                <div class="col-lg-4">
                  <div class="row">
                    <div class="col-lg-12">
                      <h3>Usage </h3>
                      <p>
                        You can use the 'btntype' attribute to specify the type
                        of the button. See Bootstrap
                        <a
                    ...
                    <div class="col-lg-12">
                      <pre>
                        <code class="lang-tsx">
                          ...
                          <br />
                          <span class="hljs-built_in ml-4">size=""</span>
                          <br />
                          <span class="hljs-built_in ml-4">backdrop=true</span>
                          <br />
                          <span class="hljs-built_in ml-4">keyboard=true</span>
                          <br />
                          <span class="hljs-built_in ml-4">
                            modalfocus=true
                          </span>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Modals have two optional sizes, available via modifier
                          classes to be placed on a .modal-dialog. These sizes
                          kick in at certain breakpoints to avoid horizontal
                          scrollbars on narrower viewports. Acceptable values:
                          'large', 'small', ''
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          ...
                          specify static for a backdrop which doesn't close the
                          modal on click.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          Shows button for modal toggle or not (which can be
                          toggled by methods).
                        </td>
                      </tr>
                      <tr>

                                ...
                                <div class="col-lg-8">
                                    ...
                                    >
                                        <div slot="dropdown-trigger">
                                            <button class="btn btn-primary ml-5 mt-2" aria-expanded="true"
                                                    type="button">Example dropdown
                                            </button>
                                        </div>

                                        <div slot="dropdown-content">
                                            <div>
                                                <a class="dropdown-item" role="presentation" href="#">First example
                                                    item</a>
                                ...
                                <div class="col-lg-4">
                                    <div class="dropdown">
                                        <button class="btn btn-info dropdown-toggle ml-1 mt-2 w-75"
                                                ...
                                                type="button">Select position
                                        </button>
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item"
                                               role="presentation"
                                               onClick={() => this.setExamplePlacement('bottom')}>Bottom </a>

                                            <a class="dropdown-item"
                                               role="presentation"
                                               onClick={() => this.setExamplePlacement('left')}>Left </a>

                                            <a class="dropdown-item"
                                               role="presentation"
                                               onClick={() => this.setExamplePlacement('right')}>Right </a>

                                            <a class="dropdown-item"
                                               role="presentation"
                                               onClick={() => this.setExamplePlacement('top')}>Top </a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn btn-info dropdown-toggle ml-1 mt-2 w-75"
                                                data-toggle="dropdown" aria-expanded="false"
                                                type="button">Select alignment
                                        </button>
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" role="presentation"
                                               onClick={() => this.setExampleAlignment('')}>None
                                                (centered)</a>
                                            <a class="dropdown-item" role="presentation"
                                               onClick={() => this.setExampleAlignment('start')}>Start </a>
                                            <a class="dropdown-item" role="presentation"
                                               onClick={() => this.setExampleAlignment('end')}>End </a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <button class="btn btn-info dropdown-toggle ml-1 mt-2 w-75" disabled
                                                data-toggle="dropdown" aria-expanded="false"
                                                type="button">Button overflow
                                        </button>
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" role="presentation"
                                               onClick={() => this.setExampleTriggerOverflow(true)}>True</a>
                                            <a class="dropdown-item" role="presentation"
                                               onClick={() => this.setExampleTriggerOverflow(false)}>False</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <pre><code class="lang-tsx">
                                        ...
                                        <span class="hljs-built_in ml-4">dropdown-placement</span>={<span
                                        class="hljs-built_in">'{this.formPlacementString()}'</span>} <br />
                                        <span class="ml-4">buttonOverflow={<span
                                            class="hljs-literal">'{JSON.stringify(this.exampleTriggerOverflow)}'</span>}
                                        </span>

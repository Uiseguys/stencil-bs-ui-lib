...
export class FileInputPage {
  ...
  render() {
    return (
      <div class="container">
        <h2>Basic usage</h2>
        <cwc-file-input class="mb-0"></cwc-file-input>
        <code class="mb-3 d-block p-3">&lt;cwc-file-input&gt;&lt;/cwc-file-input&gt;</code>
        ...
        <cwc-file-input method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
                        form-data-name="file" class="mb-0"></cwc-file-input>
        <code class="mb-3 d-block p-3">
          &lt;cwc-file-input method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage" form-data-name="file"&gt;&lt;/cwc-file-input&gt;
        </code>
        ...
        <cwc-file-input accept="image/*" max-file-size="1000000" class="mb-0">
        ...
        <cwc-file-input id="customizingRequestDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
                        form-data-name="file" class="mb-0"></cwc-file-input>
        <code class="mb-3 d-block p-3">
          &lt;cwc-file-input id="customizingRequestDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
          form-data-name="file"&gt;&lt;/cwc-file-input&gt;<br/><br/>

          &lt;script&gt;
          <div class="ml-3">
            window.addEventListener('DOMContentLoaded', function() &#123;
            <div class="ml-3">
              var upload = document.querySelector('cwc-file-input#customizingRequestDemo');<br/><br/>
        ...
        <cwc-file-input id="rawFilesDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
                        form-data-name="file" class="mb-0"></cwc-file-input>
        <code class="mb-3 d-block p-3">
          &lt;cwc-file-input id="rawFilesDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
          form-data-name="file"&gt;&lt;/cwc-file-input&gt;<br/><br/>
          ...
          <div class="ml-3">
            window.addEventListener('DOMContentLoaded', function() &#123;
            <div class="ml-3">
              var upload = document.querySelector('cwc-file-input#rawFilesDemo');<br/><br/>
        ...
        <cwc-file-input id="responseDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
                        form-data-name="file" class="mb-0"></cwc-file-input>
        <code class="mb-3 d-block p-3">
          &lt;cwc-file-input id="responseDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
          form-data-name="file"&gt;&lt;/cwc-file-input&gt;<br/><br/>
          ...
          <div class="ml-3">
            window.addEventListener('DOMContentLoaded', function() &#123;
            <div class="ml-3">
              var upload = document.querySelector('cwc-file-input#responseDemo');<br/><br/>
        ...
        <code class="mb-3 d-block p-3">
          &lt;cwc-file-input id="preFillDemo" method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
          accept="application/pdf" form-data-name="file"&gt;&lt;/cwc-file-input&gt;<br/><br/>
          ...
          <div class="ml-3">
            window.addEventListener('DOMContentLoaded', function() &#123;
            <div class="ml-3">
              var upload = document.querySelector('cwc-file-input#preFillDemo');<br/><br/>
              upload.files = [
              <div class="ml-3">
        ...
        <code class="mb-3 d-block p-3">
          &lt;cwc-file-input id="manualUploadDemo" no-auto method="post" target="https://virtserver.swaggerhub.com/bakirmanar/POST_API/1.0.0/pet/1/uploadImage"
          form-data-name="file"&gt;&lt;/cwc-file-input&gt;<br/>
          ...
          <div class="ml-3">
            window.addEventListener('DOMContentLoaded', function() &#123;
            <div class="ml-3">
              var upload = document.querySelector('cwc-file-input#manualUploadDemo');<br/>
  ...
  private initCustomizingRequestDemo () {
    let script = 'var upload = document.querySelector(\'cwc-file-input#customizingRequestDemo\');\n' +
      '\n' +
      '    upload.addEventListener(\'upload-before\', function(event) {\n' +
    ...
    this.addScript('cwc-file-input#customizingRequestDemo', script);

  }

  private initRawFilesDemo () {
    let script =
      '              var upload = document.querySelector(\'cwc-file-input#rawFilesDemo\');\n' +
      '  \n' +
      '              upload.addEventListener(\'upload-request\', function(event) {\n' +
      '                event.preventDefault();\n' +
      '                event.detail.xhr.send(event.detail.file);\n' +
  ...
  private initManualUploadDemo () {
    ...
    this.addScript('cwc-file-input#manualUploadDemo', script);
  }

  private initResponseDemo () {
    let script = 'var upload = document.querySelector(\'cwc-file-input#responseDemo\');\n' +
      '\n' +
      '              upload.addEventListener(\'upload-response\', function(event) {\n' +
    ...
    this.addScript('cwc-file-input#responseDemo', script);
  }
}

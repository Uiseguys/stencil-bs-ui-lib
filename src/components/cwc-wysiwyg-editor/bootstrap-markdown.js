...
var Markdown = function(element, options) {
  ...
  this.$options = Object.extend(true, {}, $.fn.markdown.defaults, options);
...
$(document)
  .on('click.markdown.data-api', '[data-provide="markdown-editable"]', function(
    e
  ) {
    initMarkdown($(this));
    e.preventDefault();
